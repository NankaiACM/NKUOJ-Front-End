  ...
  <div>
    ...
    <div class="ms-4 me-4">
      <div class="input-group">
        <input type="number" class="form-control" placeholder="请输入题目ID..." v-model="pid">
        <button class="btn btn-outline-purple" @click="jumpTo()">跳转</button>
      </div>
    </div>
  </div>
</template>
...
export default {
  name: "PanelJump",
  components: {IconChevronDoubleRightSmall, IconJump},
  data: function () {
    return {
      pid: null,
      state: null
