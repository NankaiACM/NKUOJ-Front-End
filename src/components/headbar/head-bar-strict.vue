        ...
        <b-collapse id="nav-collapse" is-nav>
          ...
          <b-navbar-nav class="ml-auto">
            <b-nav-item-dropdown right>
              ...
              <b-dropdown-item @click="$router.push('/home')" v-if="$store.getters.isAdministrator || !$store.getters.isStrictMode"><b-icon icon="signpost2" class="mr-1"></b-icon>退出考试</b-dropdown-item>
